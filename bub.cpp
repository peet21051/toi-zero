...
int main() {
    ...
    int teaEnergy = 0;
    if (z == 'R') {
        if (a == 1) teaEnergy = 12 * b;
        else if (a == 2) teaEnergy = 18 * b;
        else if (a == 3) teaEnergy = 25 * b;
    } else if (z == 'T') {
        if (a == 1) teaEnergy = 15 * b;
        else if (a == 2) teaEnergy = 20 * b;
        else if (a == 3) teaEnergy = 30 * b;
    } else if (z == 'M') {
        if (a == 1) teaEnergy = 10 * b;
        else if (a == 2) teaEnergy = 15 * b;
        else if (a == 3) teaEnergy = 20 * b;
    }
